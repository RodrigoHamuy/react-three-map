...
import { DirectionalLight, Matrix4, PerspectiveCamera, Scene, Vector2Tuple, Vector3, WebGLRenderer } from "three";
...
export const VanillaThreeLayer = memo<VanillaThreeLayerProps>(({
  ...
  useEffect(()=>{
    ...
    init({map: map.current.getMap(), latitude, longitude});
...
function init({map, latitude, longitude}: {map: Map, longitude: number, latitude: number}) {
